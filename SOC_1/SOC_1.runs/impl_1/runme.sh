...
HD_PWD='D:/TAI_LIEU/DU_AN_XU_LY_TINHIEU/XU_LY_TIN_HIEU_FPGA/IP_FPGA/H_function/SOC_1/SOC_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOC_1_wrapper.tcl -notrace
