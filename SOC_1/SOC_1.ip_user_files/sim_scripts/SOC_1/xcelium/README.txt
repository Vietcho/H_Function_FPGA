...
#
# Generated by export_simulation on Thu Aug 20 09:51:12 +0700 2026
#
################################################################################
...
'-reset_run' switch to the './SOC_1.sh' script.
...
./SOC_1.sh -noclean_files

For more information on the script, please type './SOC_1.sh -help'.
